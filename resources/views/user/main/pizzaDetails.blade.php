            ...
            <div class="h-100 bg-light p-30">
                ...
                <a href="{{ route('user#home') }}">
                    <div class="float-right mb-2">
                        <button class="btn btn-primary" type="submit"><i class="fa-regular fa-hand-point-left mr-2"></i>Back</button>
                    </div>
                </a>
            </div>
        </div>
    ...
    <div class="row px-xl-5">
        <div class="col">
            <div class="owl-carousel related-carousel">
               @foreach ($pizzaList as $listPizza )
                    <div class="product-item bg-light">
                        <div class="product-img position-relative overflow-hidden">

                            <img class="img-fluid w-100" src="{{ asset('storage/'.$listPizza->image) }}" style="height: 190px" alt="">
                            <div class="product-action">
                                <a class="btn btn-outline-dark btn-square" href=""><i
                                    class="fa fa-shopping-cart"></i></a>
                            <a class="btn btn-outline-dark btn-square" href="{{ route('pizza#details',$listPizza->id) }}"><i
                                    class="fa-solid fa-circle-info"></i></a>
                            </div>
                        </div>
                        <div class="text-center py-4">
                            <a class="h6 text-decoration-none text-truncate" href=""><h5>{{ $listPizza->name }}</h5></a>
                            <div class="d-flex align-items-center justify-content-center mt-2">
                                <h5>{{ $listPizza->price }} Kyats</h5>
                            </div>
                            <div class="d-flex align-items-center justify-content-center mb-1">
                                ...
                                <small class="fa fa-star text-primary mr-1"></small>
                                <small class="fa fa-star text-primary mr-1"></small>
                                <small><i class="fa-solid fa-eye me-2"></i>{{ $listPizza->view_count }}</small>
                            </div>
                        </div>
                    </div>
               @endforeach
